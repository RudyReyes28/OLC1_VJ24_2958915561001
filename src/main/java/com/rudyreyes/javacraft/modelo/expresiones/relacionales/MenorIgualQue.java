 ...
 * @author rudyo
 */
public class MenorIgualQue extends Instruccion {
    
    private Instruccion operando1;
    private Instruccion operando2;
    
    public MenorIgualQue(Instruccion operando1, Instruccion operando2, int linea, int columna) {
    ...
    public Object interpretar(Arbol arbol, TablaSimbolos tabla) {
        ...
        return operacionMenorIgualQue(opIzq, opDer);
    }
    
    public Object operacionMenorIgualQue(Object op1, Object op2){
        ...
        switch (tipo1) {
            ...
            default -> {
                return new Errores("SEMANTICO", "Tipo de dato no soportado para la comparación (MENOR IGUAL QUE): " + tipo1, this.linea, this.columna);
            }
        }
