 ...
 * @author rudyo
 */
public class MayorQue extends Instruccion{
    
    private Instruccion operando1;
    private Instruccion operando2;
    
    public MayorQue(Instruccion operando1, Instruccion operando2, int linea, int columna) {
    ...
    public Object interpretar(Arbol arbol, TablaSimbolos tabla) {
        ...
        return operacionMayorQue(opIzq, opDer);
    }
    
    public Object operacionMayorQue(Object op1, Object op2){
        ...
        switch (tipo1) {
            ...
            default -> {
                return new Errores("SEMANTICO", "Tipo de dato no soportado para la comparación (MAYOR QUE): " + tipo1, this.linea, this.columna);
            }
        }
