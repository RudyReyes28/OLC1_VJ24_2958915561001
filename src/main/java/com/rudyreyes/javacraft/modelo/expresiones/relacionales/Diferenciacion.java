...
public class Diferenciacion  extends Instruccion{
    ...
    public Diferenciacion(Instruccion operando1, Instruccion operando2, int linea, int columna) {
    ...
    public Object interpretar(Arbol arbol, TablaSimbolos tabla) {
        ...
        return operacionDiferente(opIzq, opDer);
    }
    
    public Object operacionDiferente(Object op1, Object op2){
        ...
        switch (tipo1) {
            ...
            default -> {
                return new Errores("SEMANTICO", "Tipo de dato no soportado para la diferenciacion: " + tipo1, this.linea, this.columna);
            }
        }
